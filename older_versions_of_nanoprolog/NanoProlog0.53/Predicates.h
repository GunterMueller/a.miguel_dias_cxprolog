...
typedef struct Predicate
{
	...
	Functor *functor ;				/* Predicate functor */
...
char *PredNameArity(PredicatePt pr) ;
void EnterUserMode(void) ;

Predicate *InstallCPredicate(char *name, int arity, Proc cProc) ;
void StopInstallCPredicates(void) ;
