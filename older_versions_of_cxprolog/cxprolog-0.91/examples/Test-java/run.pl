...
test_fields :-
	...
	java_call('Test', '<init>:()V', [], R5), java_field(R5, 'j:J', _, 22.499999999999999999999), java_field(R5, 'j:J', F, F), writeln(F), 
...
test_array5 :-
	java_field('Ljava/lang/Integer;','TYPE:Ljava/lang/Class;', C,C),
...
test_conversions :-
	...
	java_convert('Ljava/lang/Class;',X12,'I'), java_convert('Ljava/lang/Class;',X12,Z12), writeln(Z12),
	java_convert('Ljava/lang/Class;',X,'I'), java_field('Ljava/lang/Integer;', 'TYPE:Ljava/lang/Class;',Y,Y), java_same(X,Y), writeln(same).
...
Testing the need for ids cache
