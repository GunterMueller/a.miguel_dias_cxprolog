...
typedef struct Predicate
{
	...
	Pt args[3] ;					
	ClausePt clauses ;				/* Clause list (its also the 4th argument) */
...
Bool GetForceVisibilityFlag(void) ;

void ImportPredicate(PredicatePt pr, Pt term) ;
void CheckImports(void) ;

Predicate *InstallCBuiltinPred(CharPt name, int arity, Proc cProc) ;
void FinishInstallingCBuiltinPreds(void) ;
