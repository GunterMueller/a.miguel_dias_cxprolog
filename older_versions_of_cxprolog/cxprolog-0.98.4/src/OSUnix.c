...
{
/* CxProlog is not thread-safe. This specific call
...
#else
/* It's OK to return -1 in the remaining cases */
    return -1;
#endif
}
...
Huge OSTotalSystemMemory(void)
{
#ifdef _SC_PHYS_PAGES
/* POSIX */
 	Huge pages = sysconf(_SC_PHYS_PAGES);
	Huge page_size = sysconf(_SC_PAGE_SIZE);
