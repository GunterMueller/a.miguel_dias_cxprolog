...
static void PAbolishAll(void)
{
	AbolishAll() ;
	JumpNext() ;
}

static void PGetContext(void)
{
	MustBe( Unify(X0, C) ) ;
}

static void PGetHContext(void)
{
	MustBe( Unify(X0, CH) ) ;
}

static void PUnitSpec(void)
{
	UnitPt u = CurrUnit() ;
	Ensure( C != tNilAtom ) ;
...
static void PNDCurrentUnit(void)
{
