...
void CheckHost(void)
{
    ...
    if( cPInt(stacksBegin) < 0 )
        FatalError("This machine is backwards") ;
    if( GetTag3(stacksBegin) != 0 )
...
static void LvrExpand(void)
{
	...
	Size newCapacity = 2 * oldCapacity ;
...
{
	Size oldTrailSize = trailEnd - trailBegin ;
	Size newTrailSize = 2 * oldTrailSize ;
...
static void TrailBasicGCMark(void)
...
static void MachineStateBasicGCMark(void)
{
...
/*
void MachineStateUnitGCMark(void)
{
...
static void PDeterministic(void)
{
