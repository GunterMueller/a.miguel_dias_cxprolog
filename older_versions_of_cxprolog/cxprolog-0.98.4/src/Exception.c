...
static void PThrow(void)
{
	Throw(X0) ;
	InternalError("PThrow") ;
}

static void PRaiseException(void)
{
	Throw(X0) ;
	InternalError("PRaiseException") ;
}

static void PWriteException(void)
{
	WriteException(X0) ;
	JumpNext() ;
}
