 ...
 * radical change in some algorithms used in CxProlog, since version 0.96.
 */
...
/*
a :- X=f(a(1),b(1),g(c(1),d(1),X)), cyclic_term(X).

f/3.  a/1.  b/1.  g/3.  c/1.  d/1.  f/3.  a/1.  b/1. cycle_detected
*/
...
#define Cyclic2_PrepareArgs(args1, args2, arity, replacement)			\
	Do(	ScratchPush(*h1) ;		/* Save subterm being visited in 1 */	\
