...
static void PArrayCheck(void)
{
	MustBe( XExtraCheck(arrayType, X0) ) ;
}

static void PArrayNew(void)
{
	BindVarWithExtra(X0, ArrayNew()) ;
	JumpNext() ;
}

static void PArrayClear(void)
{
	ArrayClear(XTestExtra(arrayType,X0)) ;
	JumpNext() ;
}

static void PArrayDelete(void)
{
...
static void PArraySet(void)
{
	ArraySet(XTestExtra(arrayType,X0), XTestPosInt(X1)-1, X2) ;
	JumpNext() ;
}

static void PArrayGet(void)
{
	Pt t ;
