...
static void PTrue(void)
{
	JumpNext() ;
}

static void PFalse(void)
{
	DoFail() ;
}
...
static void PUndef(void)
{
	DoFail() ;
}

static void PNDRepeat0(void)
{
	JumpNext() ;
}

static void PNDRepeat1(void)
{
	if( A(1) == tNilAtom ) {
		A(0) = Drf(A(0)) ;
...
static void PAsserta(void)
{
	AddNewClause(X0, false, false, false) ;
	JumpNext() ;
}

static void PAssertz(void)
{
	AddNewClause(X0, true, false, false) ;
	JumpNext() ;
}

static void PTopAssert(void)
{
	AddNewClause(X0, true, false, true) ;
	JumpNext() ;
}

static void PAbolish(void)
{
	PredicatePt pr ;
...
static void PRenameBuiltin(void)
{
	FunctorPt f ;
	PredicatePt pr ;
	if( !Booting() )
...
static void PHideNonCoreBuiltins(void)
{
	PredicatePt pr ;
	if( !Booting() )
...
static void PCheckCoreBuiltin(void)
{
...
static void PDiscontiguous(void)
{
...
static void PBuildIndexesNow(void)
{
	BuildIndexesNow() ;
	JumpNext() ;
}

static void PSetOnError(void)
{
	PredicatePt pr ;
...
static void PTestRenameBuiltin(void)
{
	Mesg("Hello $$_test_rename_builtin") ;
	JumpNext() ;
}

static void PPosAnotherPred(void)
{
	Mesg("PPosAnotherPred") ;
	JumpNext() ;
}

static void PPosTest(void)
{
