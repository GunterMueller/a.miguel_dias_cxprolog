...
#define scratchInitialCapacity	(scratchDebugging_flag ? MemoryPortion(0.001) : 1 K) /* words */
...
Bool ScratchExpand(void)
{
	...
	Size newScratchCapacity = 2 * oldScratchCapacity;
	Size offset ;
	Hdl newScratch, h ;
