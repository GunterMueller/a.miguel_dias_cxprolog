...
#define MyAppVerName "CxProlog 0.97.0"
...
LicenseFile=C:\cxprolog-0.97.0-windows\COPYING.txt
InfoBeforeFile=C:\cxprolog-0.97.0-windows\INSTALL-windows.txt
OutputBaseFilename=cxprolog-0.97.0-windows
Compression=lzma
SolidCompression=yes
PrivilegesRequired=none

VersionInfoVersion=0.97.0
...
[Messages]
BeveledLabel=CxProlog 0.97.0 @ Artur Miguel Dias, 2008

[Dirs]
Name: "{userdocs}\CxProlog uninstaller"

[Files]
Source: "C:\cxprolog-0.97.0-windows\*"; Excludes: ".*,CVS"; DestDir: "{app}"; Components: base; Flags: ignoreversion recursesubdirs createallsubdirs
