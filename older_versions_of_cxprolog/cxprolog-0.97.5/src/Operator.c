...
void MakePrefixOperator(CharPt n, int p, Bool a)
{
...
void MakeInfixOperator(CharPt n, int p, Bool la, Bool ra)
{
	register OperatorPt op = LookupOperatorByName(n, true) ;
	op->inPriority = p ;
	op->inLAssoc = la ;
...
void MakePosfixOperator(CharPt n, int p, Bool a)
{
	register OperatorPt op = LookupOperatorByName(n, true) ;
	op->posPriority = p ;
	op->posAssoc = a ;
...
/* xfy -- infix right associative */
	...
	MakeInfixOperator(":" ,		   600, false, false) ;		/* q-ISO */
