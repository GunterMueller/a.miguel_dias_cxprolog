...
/*       name                          flag                         type   dflt                 updateProc        invisible   readOnly  */
	...
	{"bar_is_semicolon",			&barIsSemicolon_flag,			'b',	0,						nil,			false,		false3	},
	...
	{"unknown",						&unknown_flag,					'e',	1,						nil,			false,		false3	},  
...
static void SetDebuggingFlag(Str f)
{
	...
	elif( StrEqual(f, "mesg") )			infoMessages_debugging = 2 ;
	elif( StrEqual(f, "sys_trace1"))	sysTrace_debugging = 1 ;
	elif( StrEqual(f, "sys_trace2"))	sysTrace_debugging = 2 ;
	elif( StrEqual(f, "sys_trace3"))	sysTrace_debugging = 3 ;
	elif( StrEqual(f, "sys_trace4"))	sysTrace_debugging = 4 ;
	elif( StrEqual(f, "sys_trace"))		sysTrace_debugging = 3 ;
