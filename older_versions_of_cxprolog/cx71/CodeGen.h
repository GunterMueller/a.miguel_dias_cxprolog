...
#define CodeOverflow()			( codePt >= codeBufferEnd )
#define CodeStart()				( codeBuffer )
#define CodeReset2(cb)			( codePt = cb )
#define CodeReset()				( codePt = codeBuffer )
#define CodeSkip(n)				( codePt += (n) )
#define CodeSize()				( codePt - codeBuffer )
