...
Pt tNilAtom, tEmptyAtom, tEofAtom, tCutAtom, tTrueAtom, tFalseAtom,
	...
	tUserAtom, tVoidAtom, tNullAtom, tMarkAtom,
...
FunctorPt commaFunctor, semicolonFunctor, neckFunctor, commandFunctor,
        ...
        eqFunctor, barFunctor, minusFunctor, hifenFunctor, plusFunctor,
		bracketsFunctor, parFunctor, varFunctor, primitiveFunctor,
		unitParamFunctor, emptyFunctor, errorFunctor, ctxPushFunctor,
