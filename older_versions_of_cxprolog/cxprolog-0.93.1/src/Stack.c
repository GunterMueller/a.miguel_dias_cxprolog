...
static Size StacksBasicGCMarkAux(VoidPt x)
{
...
static void StacksBasicGCMark()
{
	ExtraForEach(stackType, StacksBasicGCMarkAux) ;
}
...
void StacksInit()
{
	stackType = ExtraTypeNew("STACK", WordsOf(Stack), nil, nil) ;
	InstallBasicGCHandler("STACK", StacksBasicGCMark) ;
