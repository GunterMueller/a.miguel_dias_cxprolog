...
static Size ArraysBasicGCMarkAux(VoidPt x)
{
...
static void ArraysBasicGCMark()
{
	ExtraForEach(arrayType, ArraysBasicGCMarkAux) ;
}
...
void ArraysInit()
{
	arrayType = ExtraTypeNew("ARRAY", WordsOf(Array), nil, nil) ;
	InstallBasicGCHandler("ARRAY", ArraysBasicGCMark) ;
