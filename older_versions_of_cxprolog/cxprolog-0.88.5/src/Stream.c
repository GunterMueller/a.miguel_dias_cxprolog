...
#if 0
/* Just for testing float i/o routines.*/
	if( setlocale(LC_NUMERIC, "") == nil ) {
		fprintf(stderr, "Could not initialize locale LC_NUMERIC\n") ;
		exit(1) ;
	}
#endif
...
/* setup descriptor */
	...
	if( locale != nil && !EqualStr(locale, "text") )
