...
static void UndefPredInst(void)
{
	AllocEnv() ;
...
static void UndefPredEndInst(void)
{
	C = Y(OutPerm(0)) ;
	Jump(DeallocProceed) ;
}

static void ImportInst(void)
{
	if( C == tNilAtom )
...
static void ImportEndInst(void)
{
	C = Y(OutPerm(0)) ;
	Jump(DeallocProceed) ;
}

static void CtxSwitchInst(void)
{
	if( C == tNilAtom )
...
static void CtxExtensionInst(void)
{
	AllocEnv() ;
...
static void CtxExtensionEndInst(void)
{
	C = CtxNext(C) ;
	Jump(DeallocProceed) ;
}

static void CtxEmptyInst(void)
{
	AllocEnv() ;
...
static void CtxEmptyEndInst(void)
{
	C = Y(OutPerm(0)) ;
	Jump(DeallocProceed) ;
}

static void CtxDownInst(void)
{
	if( C == tNilAtom )
...
static void CtxDownEndInst(void)
{
	C = Y(OutPerm(0)) ;
	Jump(DeallocProceed) ;
}

static void HCtxPushInst(void)
{
	AllocEnv() ;
...
static void HCtxPushEndInst(void)
{
	CH = CtxNext(CH) ;
	Jump(DeallocProceed) ;
}

static void HCtxEnterInst(void)
{
	if( CH == tNilAtom )
...
static void HCtxEnterEndInst(void)
{
	C = Y(OutPerm(0)) ;
	CH = Y(OutPerm(1)) ;
	Jump(DeallocProceed) ;
...
static void ContextualEmptyPredInst(void)
{
	Jump(EmptyPred) ;
}

static void ContextualDynamicEnterInst(void)
{
	Jump(DynamicEnter) ;
}

static void ContextualDynamicElseInst(void)
{
	Jump(DynamicElse) ;
}
