...
public class MyJFrame extends JFrame
{
	...
	public MyJFrame(String title) {
		...
		button.addActionListener(new ActionListener() {
			...
			//	System.out.println("event -> " + button.getColor());
				Prolog.coroutiningInput("mythread", "ola\n");
			//	Prolog.coroutiningInput("mythread", "writeln(\nuser\n,\nzzz\n");
			//	Prolog.coroutiningInput("mythread", "repeat, writeln(ola), fail.\n");
			//	Prolog.coroutiningInput("mythread", "features.\n");
			//	Prolog.coroutiningInput("mythread", "streams.\n");
			//	Prolog.coroutiningInput("mythread", "streams, restart, streams.\n");
			//	Prolog.coroutiningInput("mythread", "between(0,10000,X).\n");
			//	Prolog.coroutiningInput("mythread", "write(user_error, 'FGFDSGFDSG').\n");
			}
		});

		buttonNL.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		//		Prolog.coroutiningInput("mythread", ".\n");
		//		Prolog.coroutiningInput("mythread", "throw(a).\n");
				Prolog.coroutiningInterrupt("mythread");
				Prolog.coroutiningInput("mythread", "writeln(www).\n");
			}
		});
	...
	//	Prolog.CallProlog("mythread :- between(0,10000,X), write(X), write('.'), read(Y), writeln(Y), fail.");
		...
		Prolog.coroutiningSetAutoOutput("mythread", true);
		new MyJFrame("ola");
	}
