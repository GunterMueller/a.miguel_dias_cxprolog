...
#define ScratchIsEmpty()	(scratchChPt == scratchBegin)
#define UseScratch()		cVoidPt( ScratchIsFree()			\
								? (scratchChPt = scratchBegin)	\
								: FatalError("Scratch pad in use") )
#define FreeScratch()		( scratchChPt = nil )
#define VFreeScratch()		cVoidPt(((scratchChPt = nil), scratchBegin))
