 ...
 */
  ...
  % this file would cause no harm to CxProlog.                    %
  %                                                               %
  % Note that most CxProlog predefined builtin predicates may be  %
  % redefined, as long as a suitable alternative boot file is     %
  % provided by the user. In an alternative boot file, an         %
  % abolish_builtin/2 command has to be issued prior to each such %
  % redefinition.                                                 %
  %                                                               %
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
'$$_cond_retract'(N,A) :-
	dict_get('$$_dict',p(N,A),true), !.
'$$_cond_retract'(N,A) :-
	dict_set('$$_dict',p(N,A),true),
	abolish(N,A).
