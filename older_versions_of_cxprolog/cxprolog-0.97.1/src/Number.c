...
int floatSize ;
Pt nanFloatPt, infFloatPt, eFloatPt, piFloatPt ;
...
static Bool LookupFloatEntryAux(VoidPt x, VoidPt ref)
{
...
CharPt FloatAsStr(Char fmt, PFloat f)
{	
	switch( fmt ) {
		case 'e':
		case 'E':
...
static Size FloatSizeFun(VoidPt x)
{
...
static Size FloatsAux(VoidPt x)
{
