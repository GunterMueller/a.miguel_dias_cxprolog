...
#endif
#define CharType(c)			( ((c)<256) ? BasicCharType(c) : _SY )
...
#define CharEncode(s,c)		( Ignore(*(s)++ = (c)) )
#define CharDecode(s)		( *(s)++ )
#define CharCopy(z,a)		( *(z)++ = *(a)++ )
#define CharFirst(s)		( (s)[0] )
#define CharLast(s)			( (s)[strlen(s)-1] )
