...
#define StreamAlias(s)			((s)->alias)
#define StreamIsBinary(s)		( StreamLocale(s) == BinaryLocale() )
...
StreamPt FileStreamOpen(CharPt name, StreamMode mode, OpenStreamOptionsPt so, Pt bind) ;
StreamPt BufferStreamOpen(BufferPt buff, StreamMode mode, OpenStreamOptionsPt so, Pt bind) ;
