...
static void PGuiGfxCreateEND() {
	BindVarWithExtra(X5, MakeWxObj(gframe, nil));
}
...
static void PGuiGfxPutPixelEND() {
	BindVarWithExtra(X6, MakeWxObj(obj, nil));	
}
...
static void PGuiGfxLineEND() {
	BindVarWithExtra(Xc(8), MakeWxObj(obj, nil));
}
...
static void PGuiGfxCircleEND() {
	BindVarWithExtra(X7, MakeWxObj(obj, nil));
}
...
static void PGuiGfxDrawTextEND() {
	BindVarWithExtra(X4, MakeWxObj(obj, nil));
}
...
static void PGuiTextCreateEND() {
	BindVarWithExtra(X6, MakeWxObj(tframe, nil));
}
...
void WxAddOnsInit() {
	...
	/* GENERAL PURPOSE PREDICATES */
	InstallWxBuiltinPred("wxgui_file_chooser_simple_msg", 2, PGuiFileChooserSimpleMsg) ;
	InstallWxBuiltinPred("wxgui_file_chooser_multiple_simple", 1, PGuiFileChooserMultipleSimple) ;
	InstallWxBuiltinPred("wxgui_file_chooser_multiple_msg", 2, PGuiFileChooserMultipleMsg) ;
	InstallWxBuiltinPred("wxgui_directory_chooser_msg", 2, PGuiDirectoryChooser) ;
	InstallWxBuiltinPred("wxgui_alert", 1, PGuiAlert) ;
	InstallWxBuiltinPred("wxgui_choice", 2, PGuiChoice) ;
	InstallWxBuiltinPred("wxgui_choice_list", 3, PGuiChoiceList) ;
	InstallWxBuiltinPred("wxgui_choice_yes_no_cancel", 2, PGuiChoiceYesNoCancel) ;
	InstallWxBuiltinPred("wxgui_choice_ok_cancel", 2, PGuiChoiceOkCancel) ;
	InstallWxBuiltinPred("wxgui_get_text", 2, PGuiGetText) ;
	
	/* GRAPHICAL WINDOW PREDICATES */
	InstallWxBuiltinPred("wxgui_gfx_create", 6, PGuiGfxCreate) ;
	InstallWxBuiltinPred("wxgui_gfx_putpixel", 7, PGuiGfxPutPixel) ;
	InstallWxBuiltinPred("wxgui_gfx_line", 9, PGuiGfxLine) ;
	InstallWxBuiltinPred("wxgui_gfx_circle", 8, PGuiGfxCircle) ;
	InstallWxBuiltinPred("wxgui_gfx_rectangle", 9, PGuiGfxRectangle) ;
	InstallWxBuiltinPred("wxgui_gfx_circle_filled", 8, PGuiGfxCircleFilled) ;
	InstallWxBuiltinPred("wxgui_gfx_rectangle_filled", 9, PGuiGfxRectangleFilled) ;
	InstallWxBuiltinPred("wxgui_gfx_draw_text", 5, PGuiGfxDrawText) ;
	InstallWxBuiltinPred("wxgui_gfx_button", 5, PGuiGfxButton) ;
	InstallWxBuiltinPred("wxgui_gfx_list", 5, PGuiGfxList) ;
	InstallWxBuiltinPred("wxgui_gfx_list_getitem", 2, PGuiGfxListGetItem) ;
	InstallWxBuiltinPred("wxgui_gfx_delete_object", 2, PGuiGfxDeleteObject) ;
	InstallWxBuiltinPred("wxgui_gfx_clear", 1, PGuiGfxClear) ;
	InstallWxBuiltinPred("wxgui_gfx_close", 1, PGuiGfxClose) ;
	
	/* TEXT WINDOW PREDICATES */
	InstallWxBuiltinPred("wxgui_text_create", 7, PGuiTextCreate) ;
	InstallWxBuiltinPred("wxgui_text_get_file_path", 2, PGuiTextGetFilePath) ;
	InstallWxBuiltinPred("wxgui_text_open_file", 1, PGuiTextOpenFile) ;
	InstallWxBuiltinPred("wxgui_text_save_file", 1, PGuiTextSaveFile) ;
	InstallWxBuiltinPred("wxgui_text_save_file_as", 1, PGuiTextSaveFileAs) ;
	InstallWxBuiltinPred("wxgui_text_get_text", 4, PGuiTextGetText) ;
	InstallWxBuiltinPred("wxgui_text_append", 2, PGuiTextAppend) ;
	InstallWxBuiltinPred("wxgui_text_get_selected_text", 2, PGuiTextGetSelectedText) ;
	InstallWxBuiltinPred("wxgui_text_replace", 4, PGuiTextReplace) ;
	InstallWxBuiltinPred("wxgui_text_set_selection", 3, PGuiTextSetSelection) ;
	InstallWxBuiltinPred("wxgui_text_close", 1, PGuiTextClose) ;
}
