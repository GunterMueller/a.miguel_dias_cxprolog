...
/* This file demonstrates how to write builtin predicates based on wxWidgets.
   ...
   The main lessons contained in this file are the following:
		- The implementation of each wxWidgets based builtin predicates
...
/* Each wxWidgets-based builtin predicates must be written using three
   separated functions:
...
static CharPt s0, s1, s2 ;
static int i0, i1, i2 ;
static VoidPt o0, o1, o2 ;
...
{
	InstallWXCBuiltinPred("w", 2, PWCreate) ;
	InstallWXCBuiltinPred("t", 2, PWWrite) ;
	
	InstallCBuiltinPred("g", 1, PEventGet) ;
}
