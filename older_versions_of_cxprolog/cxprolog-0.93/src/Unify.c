...
int Compare(register Pt t1, register Pt t2)
{
	...
	for(;;) {
		...
		if( GetTag(t1) == GetTag(t2) ) {
			...
			elif( IsVar(t1) ) { res = -1 ; goto nextPairL ; }
			elif( IsVar(t2) ) { res = 1 ; goto nextPairL ; }
			elif( IsNumber(t1) ) { res = -1 ; goto nextPairL ; }
			elif( IsNumber(t2) ) { res = 1 ; goto nextPairL ; }
			elif( IsAtom(t1) ) { res = -1 ; goto nextPairL ; }
			elif( IsAtom(t2) ) { res = 1 ; goto nextPairL ; }
			elif( IsCompound(t1) ) { res = -1 ; goto nextPairL ; }
			elif( IsCompound(t2) ) { res = 1 ; goto nextPairL ; }
