...
static CharPt addOnJavaBuiltinsStr = "										\
																			\
/* GENERAL PURPOSE PREDICATES */											\
																			\
jgui_file_chooser_simple_msg(Msg, Fich) :-									\
	java_call('JavaGeneral',												\
...
jgui_gfx_putpixel(Window, X, Y, R, G, B, PixelObj) :-						\
	...
	check_colors(R,G,B),													\
	java_call(Window,														\
				'gfxPutPixel:(IIIII)LJavaGraphicalObject;',					\
				[X, Y, R, G, B], PixelObj).									\
																		  ""\
jgui_gfx_line(Window, X0, Y0, X1, Y1, R, G, B, LineObj) :-					\
	...
	check_colors(R,G,B),													\
	java_call(Window,														\
				'gfxLine:(IIIIIII)LJavaGraphicalObject;',					\
...
jgui_gfx_circle(Window, X, Y, Radius, R, G, B, CircleObj) :-				\
	...
	check_colors(R,G,B),													\
	java_call(Window,														\
				'gfxCircle:(IIIIII)LJavaGraphicalObject;',					\
...
jgui_gfx_rectangle(Window, X, Y, Width, Height, R, G, B, RectObj) :-		\
	...
	check_colors(R,G,B),													\
	java_call(Window,														\
				'gfxRectangle:(IIIIIII)LJavaGraphicalObject;',				\
...
jgui_gfx_circle_filled(Window, X, Y, Radius, R, G, B, CircleObj) :-			\
	...
	check_colors(R,G,B),													\
	java_call(Window,														\
				'gfxCircleFilled:(IIIIII)LJavaGraphicalObject;',			\
				[X,Y,Radius,R,G,B], CircleObj).								\
																			\
jgui_gfx_rectangle_filled(Window, X, Y, Width, Height, R, G, B, RectObj) :-	\
	...
	check_colors(R,G,B),													\
	java_call(Window,														\
				'gfxRectangleFilled:(IIIIIII)LJavaGraphicalObject;',		\
				[X,Y,Width,Height,R,G,B], RectObj).							\
																			\
jgui_gfx_draw_text(Window, Text, X, Y, TextObj) :-							\
	...
	integer(Y),																\
	java_call(Window,														\
				'gfxDrawText:(Ljava/lang/String;II)LJavaGraphicalObject;',	\
				[Text,X,Y], TextObj).										\
																			\
...
jgui_gfx_button(Window, Text, X, Y, ButtonObj) :-							\
	...
	integer(Y),																\
	java_call(Window,														\
				'gfxButton:(Ljava/lang/String;II)LJavaGraphicalObject;',	\
				[Text,X,Y], ButtonObj).										\
																			\
jgui_gfx_list(Window, Items, X, Y, ListObj) :-								\
	...
	integer(Y),																\
	java_call(Window,														\
				'gfxList:([Ljava/lang/String;II)LJavaGraphicalObject;',		\
				[Items,X,Y], ListObj).										\
																			\
...
jgui_gfx_delete_object(Window, Object) :-									\
	java_call(Window,														\
				'gfxDeleteObject:(LJavaGraphicalObject;)V',					\
				[X,Y,Text], _).												\
																			\
																		  ""\
...
void JavaAddOnsInit()
{
	ZBasicLoadStr(addOnJavaBuiltinsStr) ;
}
