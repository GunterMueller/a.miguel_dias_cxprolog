...
#define VarDictWords(capacity)		((capacity) * WordsOf(VarDescriptor))
...
static void VarDictExpand()
{
	...
	MemoryGrowWarning("var table", VarDictWords(oldVarDictCapacity),
									VarDictWords(newVarDictCapacity), nil) ;
