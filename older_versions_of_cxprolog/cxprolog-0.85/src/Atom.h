...
typedef struct Atom
{
	...
	struct Op *op ;					/* Operator identified by this atom */
	Bool permanent : 1 ;
	Bool marked : 1 ;
...
extern Pt tNilAtom, tEmptyAtom, tEofAtom, tCutAtom, tTrueAtom, tFalseAtom,
	...
	tQuestionAtom, tEllispisAtom, tErrorAtom, tGoingAtom,
...
extern FunctorPt commaFunctor, semicolonFunctor, neckFunctor,
		...
		metaCutFunctor, eqFunctor, barFunctor, hifenFunctor, varFunctor,
		primitiveFunctor, unitParamFunctor, emptyFunctor, ctxPushFunctor,
		ctxSwitchFunctor, ctxHEnterFunctor, ctxHExitFunctor ;
