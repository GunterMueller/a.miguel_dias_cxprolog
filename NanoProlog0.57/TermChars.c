...
/* HISTORY:
 ...
 000316: '`' changed from _SY to '`' (Now '`' is the delimiter for text literals).
 990520: ';', '#' and other trans-127 chars changed from _SO to _SY
 970805: Array of char categories introduced for the first time to cope
 			with the Latin-1 character set.
